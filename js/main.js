(function () {
  ...
  function footerHtml() {
    ...
    return (
      ...
      '<p class="footer__desc">Organização brasileira de CS2. Elenco, jogos e o campeonato interno da casa.</p>' +
      ...
      '<li><a href="/elenco">Lineup</a></li><li><a href="/jogos">Escalação</a></li>' +
      ...
      '<li><a href="/entrar">Área do time</a></li></ul></div>' +
      "</div>" +
